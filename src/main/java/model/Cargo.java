...
public class Cargo {
    ...
    @Basic
    @Column(name = "cargo_length", nullable = true, precision = 2)
    ...
    @Basic
    @Column(name = "cargo_width", nullable = true, precision = 2)
    ...
    @Basic
    @Column(name = "cargo_height", nullable = true, precision = 2)
    ...
    @Basic
    @Column(name = "cargo_weight", nullable = true, precision = 2)
    ...
    @Basic
    @Column(name = "cargo_dangerous", nullable = true)
    ...
    @Basic
    @Column(name = "cargo_fragile", nullable = true)
