...
<head>
    <meta charset="utf-8">
    <title>Главная</title>
    <link rel="stylesheet" type="text/css" href="<c:url value="/scm/html_examples/main1.css"/>" >
    <link rel="stylesheet" type="text/css" href="<c:url value="/scm/html_examples/homePage1.css"/>" >
</head>
<body>
<div class="headr">
    <header>
        ...
        <nav1 class="one">
            <ul class="topmenu">
                <li><a href="#">Авторизация<i class="fa fa-angle-down"></i></a>
                    <ul class="submenu">
                        <li><a href="<c:url value="/scm/html/signIn.jsp"/>">Вход</a></li>
                        <li><a href="<c:url value="/scm/html/signUp.jsp"/>">Регистрация</a></li>
                    </ul>
                </li>
            </ul>
        </nav1>
...
<div class="small">
    ...
    <article>
        <div>
            <div id="text"><img src="<c:url value="/scm/images/others/cars.png"/>" class="cars" alt="cars">
