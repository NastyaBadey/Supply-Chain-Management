...
<head>
    ...
    <link rel="shortcut icon" href="<c:url value="/scm/images/car-icon.png"/>" type="image/png">
</head>
<body>
        ...
        <ul class="scm-menu">
            <li>
                ...
                <ul class="scm-submenu">
                    <li class="scm-bottom-border"><a href="<c:url value="/scm/html/signIn.jsp"/>">Вход</a></li>
    ...
    <article class="scm-container">
        <div class="scm-column-container">
            ...
            <div class="scm-text-with-indent">
                <img src="<c:url value="/scm/images/others/cars.png"/>" class="cars" alt="Cars">
