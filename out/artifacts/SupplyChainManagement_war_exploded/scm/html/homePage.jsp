        ...
        <div class="scm-center-container">
            <div class="scm-column-container">
                <div class="scm-row-container scm-title-row">
                    ...
                    <div class="scm-text-with-indent">
                        ...
                        Компания <b>«TransportLogistic»</b> специализируется на международных грузоперевозках
                        комплектных и сборных грузов автомобильным
                        транспортом по направлениям: Европа—Беларусь, Россия – Беларусь, Прибалтика — Беларусь, Европа –
                        Россия,
                        Прибалтика – Россия, Европа – Казахстан и Средняя Азия, Прибалтика – Казахстан и Средняя Азия,
                        Украина – Беларусь, Прибалтика – Украина, перевозки внутри Европы (Германия – Прибалтика,
                        Германия – Польша и др.)
            ...
            <div class="scm-row-container">
                <div class="scm-column-container scm-transport-column">
                    ...
                    <div class="scm-row-container">
                        Автомобильные грузоперевозки заслужили популярность благодаря своей мобильности и невысокой
                        стоимости.
                    </div>
                </div>
                ...
                <div class="scm-column-container scm-transport-column">
                    ...
                    <div class="scm-row-container">
                        Железнодорожные перевозки грузов с уверенностью можно назвать наиболее оптимальными с точки
                        зрения сочетания цены, качества и сроков
                    </div>
                </div>
                ...
                <div class="scm-column-container scm-transport-column">
                    ...
                    <div class="scm-row-container">
                        Грузовые авиаперевозки – это один из быстрых способов доставки Вашего товара от отправителя к
                        месту назначения
                    </div>
                </div>
                ...
                <div class="scm-column-container scm-transport-column">
                    ...
                    <div class="scm-row-container">
                        Морские перевозки являются наиболее распространенным видом транспорта, которые используют
                        импортеры и экспортеры.Фактически, 90% всех грузов отгружается морским транспортом
                    </div>
                </div>
            </div>
                    ...
                    <div class="scm-list">
                        ...
                        <div class="scm-about-company">
                            <div class="scm-text-with-indent">
                                ...
                                Постоянно повышаем качество сервиса в области логистики. Мы ведем свой бизнес открыто и
                                развиваем предпринимательство
                                <br>
                            </div>
                            <div class="scm-text-with-indent">
                                <b>Строим большую компанию.</b>
                                Успех который постоен на профессионализме, саморазвитие и самореализации наших
                                сотрудников.
                                <br>
                            </div>
                            <div class="scm-text-with-indent">
                                <b>Доставляем радость и качественный сервис.</b>
                                Удовлетворяем потребности клиента и решаем любые задачи, сохраняя при этом высочайшее
                                качество продукта и клиентского сервиса.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="scm-list">
                        ...
                        <div class="scm-about-company">
                            <div class="scm-text-with-indent">
                                ...
                                Выполняем на себя обязательства перед сотрудниками. Честны и открыты с партнерами
                                компании.
                                <br>
                            </div>
                            <div class="scm-text-with-indent">
                                ...
                                Стремимся создать хорошие условия для комфортной работы, профессионального и личного
                            ...
                            <div class="scm-text-with-indent">
                                ...
                                Мы ставим перед собой большие и амбициозные цели, добиваясь результатов с помощью
                                упорного труда и настойчивости.
                            </div>
                        </div>
                    </div>
                </div>
